...
export class PostsService {
  ...
  {}
    ...
    async formatPost(p: PostEntity, currentUser: UserEntity, tag: string): Promise<PostEntity> {
      // async formatPost(p: PostEntity, currentUser: UserEntity, tag: string): Promise<any> {
      // return {
      //   ...p,
      //   // author: {
      //   //   ...p.author,
